    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 selection:bg-indigo-100">
      <div className="w-full max-w-[400px] space-y-8">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Tekrar Hoş Geldiniz</h1>
          <p className="text-sm text-gray-500 mt-2 font-medium">Öğrenci hesabınıza giriş yapın</p>
        </div>
        ...
        <Card className="shadow-xl shadow-indigo-900/5">
          ...
          <div className="flex bg-gray-100/50 p-1 rounded-xl mb-8">
             ...
             <button onClick={() => navigate('/register')} className="flex-1 py-2 text-center text-gray-500 hover:text-gray-900 font-bold text-xs transition-all rounded-lg">Kayıt Ol</button>
          </div>
